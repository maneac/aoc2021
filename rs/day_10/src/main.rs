...
mod tests {
    ...
    const PART_1: usize = 266301;
    const PART_2: usize = 3404870164;
...
<{([{{}}[<[[[<>{}]]]>[]]";
        ...
        write(Path::new("/tmp").join("day_10.txt"), data).unwrap();
