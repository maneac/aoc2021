...
fn part_1(input: &Input) -> usize {
    find_transforms(input, 12).0
}

fn part_2(input: &Input) -> usize {
    find_transforms(input, 12).1
}

fn find_transforms(input: &Input, threshold: usize) -> (usize, usize) {
...
fn fold_input(input: &Input, order: Vec<usize>, threshold: usize) -> (usize, usize) {
